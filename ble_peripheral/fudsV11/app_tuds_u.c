...
*/
PUBLIC int32_t app_tuds_Ucfm_handler( app_tuds_t *p_app_tuds, uint8_t *buf, uint8_t len)
{
    int32_t r;
    r = 0;
...
//-----------------------------------------------------------------------------
PUBLIC int32_t app_tuds_OnWrittenComplete_Ucmd_handler(app_tuds_t *p_app_tuds,  uint8_t *buf, uint8_t len) //int32_t BlkUp_On_written_Ucmd(ble_tuds_t *p_tuds,  uint8_t *buf, uint8_t len)
{
    int32_t r;
...
PUBLIC int32_t app_tuds_OnWrittenComplete_Udat_handler(app_tuds_t *p_app_tuds,  uint8_t *buf, uint8_t len) //int32_t BlkUp_On_written_Udat(ble_tuds_t *p_tuds,  uint8_t *buf, uint8_t len)
{
    int32_t r;
