...
#define SCHED_QUEUE_SIZE                 200 //10                                      //APPSH    
#endif
...
#endif
#if USE_UD2
ble_ud2_t  m_ble_ud2;                                  // Structure to identify the BLKUP Service.
...
void app_error_fault_handler(uint32_t id, uint32_t pc, uint32_t info)
{
    ...
    dbgPrint("\r\n");
    dbgPrint("app_error_handler\r\n");
    
    dbgPrintf("id   = %d 0x%x\r\n", id, id);
    dbgPrintf("pc   = %d\r\n", pc);
    dbgPrintf("info = %d 0x%x\r\n", info, info);
...
static void  dfu_init(void)
{
    ...
    dbgPrintf("ble_dfu_init()\r\n");
    err_code = ble_dfu_init(&m_dfus, &dfus_init);
    dbgPrintf("ble_dfu_init err_code= 0x%08x\r\n", err_code);
    APP_ERROR_CHECK(err_code);
...
#if USE_UD2
    dbgPrint("S[6]\r\n");
    services_init_ud2_part();  // USE_UD2
#endif
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            ...
            {
                dbgPrintf("dm_application_context_set OK\r\n");
            ...
            else
            {
                ...
                dbgPrintf("dm_application_context_set failed rtn = %d, 0x%08x\r\n", retval, retval);
            }
#endif
...
#endif
#if USE_UD2
    ble_ud2_on_ble_evt(&m_ble_ud2, p_ble_evt); //karel
#endif
...
#if USE_DM
    dbgPrintf("------------------------ sys_evt_dispatch sys_evt = %d, 0x%08x\r\n", sys_evt, sys_evt);
    ...
    switch(p_event->event_id)
    {
        ...
        {       
            ...
            if (retval == NRF_SUCCESS)
            {
                ...
                // Note do not reuse or change m_my_char.
                dbgPrintf("DDD dm_application_context_get OK\r\n");
            }
            else
            {
                dbgPrintf("DDD dm_application_context_get failed rtn = %d, 0x%08x\r\n", retval, retval);
            }
            break;
        }
        case DM_EVT_APPL_CONTEXT_LOADED:        
        {
            ...
            if (retval == NRF_SUCCESS)
            {
                // DM_EVT_APPL_CONTEXT_LOADED event generated to indicate load complete.
                // Note do not reuse or change m_my_char.
                dbgPrintf("dm_application_context_get OK\r\n");
            }
            else
            {
                dbgPrintf("dm_application_context_get failed rtn = %d, 0x%08x\r\n", retval, retval);
            }
            break;
        }
#endif
...
static void power_failure_sys_event_handler(uint32_t sys_evt)
{
    ...
    {
        dbgPrint("NRF_EVT_POWER_FAILURE_WARNING\r\n");    
    }
}
...
void reset_testing_stuff()
{
    ...
    dbgPrintf("sd_power_pof_threshold_set   err_code = 0x%08x\r\n", err_code);
...
int main_tuds(void)
{
    ...
    dbgPrint("\r\n");
//    dbgPrint("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\r\n");
//    dbgPrint("BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB\r\n");
    dbgPrint("CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC\r\n");
    dbgPrint("\r\n");
#endif
