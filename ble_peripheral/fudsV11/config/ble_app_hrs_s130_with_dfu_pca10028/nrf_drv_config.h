...
/* UART */
#define UART0_ENABLED 1 //karel - set to one, as we use the UART
...
/* ADC */
#define ADC_ENABLED 0  //karel , https://devzone.nordicsemi.com/question/75988/nrf-driver-adc-irq-priority/
