...
#ifndef TUDSAPP_CONFIG_H
#define TUDSAPP_CONFIG_H
...
// <h> app_STOP 
//==========================================================
// <q> APP_TD_STOPLINE_ENABLED  - tdk_StopLineService - Stop Line on P0.00 active low stop all and Sleep
